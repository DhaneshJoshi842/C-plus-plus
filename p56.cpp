// abstarct base class and pure virtual fn -
#include <iostream>
using namespace std;
class CWH // this class is abstract base class because it contains the pure virtual fn
{
protected:
    string title;
    float rating;
